...
const ToDoSidebar = ({ isToDoSidebarOpen, setIsToDoSidebarOpen }: ToDoSidebarProps) => {
    ...
    return (
        <div
            className={`shrink-0 flex flex-col justify-between grow-1 max-w-60 bg-zinc-100 pt-4 rounded-r-lg shadow md:h-fit md:sticky absolute top-[4.2rem] h-[calc(100vh-4.2rem)] z-[998] md:top-4 mb-8 transition-all duration-300 ${
        ...
        >
            ...
            <div className="flex items-center justify-between text-neutral-600 border-t border-t-neutral-300 py-0.5">
                <div className="flex items-center gap-4 hover:bg-stone-200 transition-colors px-4 py-2 flex-1 rounded" onClick={() => createList()}>
                    <FaPlus />
